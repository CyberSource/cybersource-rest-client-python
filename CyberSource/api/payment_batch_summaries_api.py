...
class PaymentBatchSummariesApi(object):
    ...
    def get_payment_batch_summary_with_http_info(self, start_time, end_time, **kwargs):
        ...
        isResponseMLEforApi = MLEUtility.check_is_response_mle_for_api(self.api_client.mconfig, "get_payment_batch_summary,get_payment_batch_summary_with_http_info")
