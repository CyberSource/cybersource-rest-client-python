...
class CreateNewWebhooksApi(object):
    ...
    def notification_subscriptions_v1_products_organization_id_get(self, organization_id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.notification_subscriptions_v1_products_organization_id_get(organization_id, callback=callback_function)
        ...
        if self.api_client.mconfig.log_config.enable_log:
            self.logger.info("CALL TO METHOD `notification_subscriptions_v1_products_organization_id_get` STARTED")

        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.notification_subscriptions_v1_products_organization_id_get_with_http_info(organization_id, **kwargs)
        else:
            (data) = self.notification_subscriptions_v1_products_organization_id_get_with_http_info(organization_id, **kwargs)
            return data

    def notification_subscriptions_v1_products_organization_id_get_with_http_info(self, organization_id, **kwargs):
        """
        Find Products You Can Subscribe To
        Retrieve a list of products and event types that your account is eligible for. These products and events are the ones that you may subscribe to in the next step of creating webhooks.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.notification_subscriptions_v1_products_organization_id_get_with_http_info(organization_id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method notification_subscriptions_v1_products_organization_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('organization_id' not in params) or (params['organization_id'] is None):
            if self.api_client.mconfig.log_config.enable_log:
                self.logger.error("InvalidArgumentException : Missing the required parameter `organization_id` when calling `notification_subscriptions_v1_products_organization_id_get`")
            raise ValueError("Missing the required parameter `organization_id` when calling `notification_subscriptions_v1_products_organization_id_get`")
    ...
    def notification_subscriptions_v1_webhooks_post(self, **kwargs):
        """
        Create a Webhook
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.notification_subscriptions_v1_webhooks_post(callback=callback_function)
        ...
        if self.api_client.mconfig.log_config.enable_log:
            self.logger.info("CALL TO METHOD `notification_subscriptions_v1_webhooks_post` STARTED")

        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.notification_subscriptions_v1_webhooks_post_with_http_info(**kwargs)
        else:
            (data) = self.notification_subscriptions_v1_webhooks_post_with_http_info(**kwargs)
            return data

    def notification_subscriptions_v1_webhooks_post_with_http_info(self, **kwargs):
        """
        Create a Webhook
        Create a new webhook subscription. Before creating a webhook, ensure that a security key has been created at the top of this developer center section. You will not need to pass us back the key during the creation of the webhook, but you will receive an error if you did not already create a key or store one on file. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.notification_subscriptions_v1_webhooks_post_with_http_info(callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method notification_subscriptions_v1_webhooks_post" % key
                )
            params[key] = val
        del params['kwargs']
