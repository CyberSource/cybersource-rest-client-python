...
class PurchaseAndRefundDetailsApi(object):
    ...
    def get_purchase_and_refund_details_with_http_info(self, start_time, end_time, **kwargs):
        ...
        isResponseMLEforApi = MLEUtility.check_is_response_mle_for_api(self.api_client.mconfig, "get_purchase_and_refund_details,get_purchase_and_refund_details_with_http_info")
