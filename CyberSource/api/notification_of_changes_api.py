...
class NotificationOfChangesApi(object):
    ...
    def get_notification_of_change_report_with_http_info(self, start_time, end_time, **kwargs):
        ...
        isResponseMLEforApi = MLEUtility.check_is_response_mle_for_api(self.api_client.mconfig, "get_notification_of_change_report,get_notification_of_change_report_with_http_info")
