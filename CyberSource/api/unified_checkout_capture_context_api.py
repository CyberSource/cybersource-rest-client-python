...
class UnifiedCheckoutCaptureContextApi(object):
    ...
    def generate_unified_checkout_capture_context_with_http_info(self, generate_unified_checkout_capture_context_request, **kwargs):
        ...
        isResponseMLEforApi = MLEUtility.check_is_response_mle_for_api(self.api_client.mconfig, "generate_unified_checkout_capture_context,generate_unified_checkout_capture_context_with_http_info")
