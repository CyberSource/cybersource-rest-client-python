...
class SecureFileShareApi(object):
    ...
    def get_file_with_http_info(self, file_id, **kwargs):
        ...
        isResponseMLEforApi = MLEUtility.check_is_response_mle_for_api(self.api_client.mconfig, "get_file,get_file_with_http_info")
    ...
    def get_file_detail_with_http_info(self, start_date, end_date, **kwargs):
        ...
        isResponseMLEforApi = MLEUtility.check_is_response_mle_for_api(self.api_client.mconfig, "get_file_detail,get_file_detail_with_http_info")
