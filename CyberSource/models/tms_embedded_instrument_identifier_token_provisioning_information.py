...
class TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation(object):
    """
    ...
    def __init__(self, consumer_consent_obtained=None, multi_factor_authenticated=None):
        """
        TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation - a model defined in Swagger
        """
    ...
    def consumer_consent_obtained(self):
        """
        Gets the consumer_consent_obtained of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        ...
        :return: The consumer_consent_obtained of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        :rtype: bool
        """
    ...
    def consumer_consent_obtained(self, consumer_consent_obtained):
        """
        Sets the consumer_consent_obtained of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        Flag that indicates whether the user consented to the tokenization of their credentials. Required for card network tokenization in certain markets, such as India. Possible Values: - `true`: Consumer has consented to tokenization of their credentials. - `false`: Consumer has not consented to tokenization of their credentials. 

        :param consumer_consent_obtained: The consumer_consent_obtained of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        :type: bool
        """
    ...
    def multi_factor_authenticated(self):
        """
        Gets the multi_factor_authenticated of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        ...
        :return: The multi_factor_authenticated of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        :rtype: bool
        """
    ...
    def multi_factor_authenticated(self, multi_factor_authenticated):
        """
        Sets the multi_factor_authenticated of this TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation.
        Flag that indicates whether AFA (Additional Factor of Authentication) for the PAN was completed. Required for card network tokenization in certain markets, such as India. Possible Values: - `true`: Consumer has been authenticated by the issuer. - `false`: Consumer has not been authenticated by the issuer. 
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, TmsEmbeddedInstrumentIdentifierTokenProvisioningInformation):
            return False
