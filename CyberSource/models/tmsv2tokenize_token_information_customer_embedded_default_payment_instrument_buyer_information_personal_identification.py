...
class Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification(object):
    """
    ...
    def __init__(self, id=None, type=None, issued_by=None):
        """
        Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification - a model defined in Swagger
        """
    ...
    def id(self, id):
        """
        Sets the id of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification.
        The value of the identification type. 
    ...
    def type(self, type):
        """
        Sets the type of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification.
        The type of the identification.  Possible Values:   - driver license 
    ...
    def issued_by(self):
        ...
        :return: The issued_by of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification.
    ...
    def issued_by(self, issued_by):
        """
        Sets the issued_by of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification.

        :param issued_by: The issued_by of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification.
        :type: Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationIssuedBy
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentBuyerInformationPersonalIdentification):
            return False
