...
class Riskv1authenticationsTravelInformationPassengers(object):
    """
    ...
    def __init__(self, first_name=None, last_name=None):
        """
        Riskv1authenticationsTravelInformationPassengers - a model defined in Swagger
        """
    ...
    def first_name(self):
        """
        Gets the first_name of this Riskv1authenticationsTravelInformationPassengers.
        ...
        :return: The first_name of this Riskv1authenticationsTravelInformationPassengers.
        :rtype: str
        """
    ...
    def first_name(self, first_name):
        """
        Sets the first_name of this Riskv1authenticationsTravelInformationPassengers.
        First name of the passenger to whom the ticket was issued. If there are multiple passengers, include all listed on the ticket. Do not include special characters such as commas, hyphens, or apostrophes. Only ASCII characters are supported. Required for American Express SafeKey (U.S.) for travel-related requests. 

        :param first_name: The first_name of this Riskv1authenticationsTravelInformationPassengers.
        :type: str
        """
    ...
    def last_name(self):
        """
        Gets the last_name of this Riskv1authenticationsTravelInformationPassengers.
        ...
        :return: The last_name of this Riskv1authenticationsTravelInformationPassengers.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """
        Sets the last_name of this Riskv1authenticationsTravelInformationPassengers.
        Last name of the passenger to whom the ticket was issued. If there are multiple passengers, include all listed on the ticket. Do not include special characters such as commas, hyphens, or apostrophes. Only ASCII characters are supported. Required for American Express SafeKey (U.S.) for travel-related requests. 

        :param last_name: The last_name of this Riskv1authenticationsTravelInformationPassengers.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Riskv1authenticationsTravelInformationPassengers):
            return False
