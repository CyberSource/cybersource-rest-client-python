...
class Ucv1sessionsDataOrderInformationShippingDetails(object):
    """
    ...
    def __init__(self, shipping_method=None, ship_from_postal_code=None):
        """
        Ucv1sessionsDataOrderInformationShippingDetails - a model defined in Swagger
        """
    ...
    def shipping_method(self):
        """
        Gets the shipping_method of this Ucv1sessionsDataOrderInformationShippingDetails.
        ...
        :return: The shipping_method of this Ucv1sessionsDataOrderInformationShippingDetails.
        :rtype: str
        """
    ...
    def shipping_method(self, shipping_method):
        """
        Sets the shipping_method of this Ucv1sessionsDataOrderInformationShippingDetails.
        Shipping method for the product. Possible values:   - `lowcost`: Lowest-cost service  - `sameday`: Courier or same-day service  - `oneday`: Next-day or overnight service  - `twoday`: Two-day service  - `threeday`: Three-day service  - `pickup`: Store pick-up  - `other`: Other shipping method  - `none`: No shipping method because product is a service or subscription 

        :param shipping_method: The shipping_method of this Ucv1sessionsDataOrderInformationShippingDetails.
        :type: str
        """
    ...
    def ship_from_postal_code(self):
        """
        Gets the ship_from_postal_code of this Ucv1sessionsDataOrderInformationShippingDetails.
        ...
        :return: The ship_from_postal_code of this Ucv1sessionsDataOrderInformationShippingDetails.
        :rtype: str
        """
    ...
    def ship_from_postal_code(self, ship_from_postal_code):
        """
        Sets the ship_from_postal_code of this Ucv1sessionsDataOrderInformationShippingDetails.
        Postal code for the address from which the goods are shipped, which is used to establish nexus.  The default is the postal code associated with your CyberSource account.  The postal code must consist of 5 to 9 digits.  When the billing country is the U.S., the 9-digit postal code must follow this format:  `[5 digits][dash][4 digits]`  Example 12345-6789  When the billing country is Canada, the 6-digit postal code must follow this format:  `[alpha][numeric][alpha][space] [numeric][alpha][numeric]`  Example A1B 2C3  This field is frequently used for Level II and Level III transactions. 

        :param ship_from_postal_code: The ship_from_postal_code of this Ucv1sessionsDataOrderInformationShippingDetails.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ucv1sessionsDataOrderInformationShippingDetails):
            return False
