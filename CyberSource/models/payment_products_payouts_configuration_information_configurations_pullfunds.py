...
class PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds(object):
    """
    ...
    def __init__(self, acquirer_organization_id=None, acquiring_bin=None, allow_crypto_currency_purchase=None, card_acceptor_id=None, originator_mvv=None, originator_name_abbreviation=None, card_terminal_id=None):
        """
        PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds - a model defined in Swagger
        """
    ...
    def acquirer_organization_id(self):
        """
        Gets the acquirer_organization_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        Valid organization in OMS with an organizationInformation.type as \"acquirer\".

        :return: The acquirer_organization_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: str
        """
    ...
    def acquirer_organization_id(self, acquirer_organization_id):
        """
        Sets the acquirer_organization_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        Valid organization in OMS with an organizationInformation.type as \"acquirer\".

        :param acquirer_organization_id: The acquirer_organization_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: str
        """
    ...
    def acquiring_bin(self):
        """
        Gets the acquiring_bin of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        ...
        :return: The acquiring_bin of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: int
        """
    ...
    def acquiring_bin(self, acquiring_bin):
        """
        Sets the acquiring_bin of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        This code identifies the financial institution acting as the acquirer of this transaction. The acquirer is the client or system user that signed the originator or installed the unattended cardholder- activated environment. When a processing center operates for multiple acquirers, this code is for the individual client or system user, not a code for the center.

        :param acquiring_bin: The acquiring_bin of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: int
        """
    ...
    def allow_crypto_currency_purchase(self):
        """
        Gets the allow_crypto_currency_purchase of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        This configuration allows a transaction to be flagged for cryptocurrency funds transfer.

        :return: The allow_crypto_currency_purchase of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: bool
        """
    ...
    def allow_crypto_currency_purchase(self, allow_crypto_currency_purchase):
        """
        Sets the allow_crypto_currency_purchase of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        This configuration allows a transaction to be flagged for cryptocurrency funds transfer.

        :param allow_crypto_currency_purchase: The allow_crypto_currency_purchase of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: bool
        """
    ...
    def card_acceptor_id(self):
        """
        Gets the card_acceptor_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        A unique identifier number for the originator of transfers that is unique to the processor or acquirer.

        :return: The card_acceptor_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: str
        """
    ...
    def card_acceptor_id(self, card_acceptor_id):
        """
        Sets the card_acceptor_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        A unique identifier number for the originator of transfers that is unique to the processor or acquirer.

        :param card_acceptor_id: The card_acceptor_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: str
        """
    ...
    def originator_mvv(self):
        """
        Gets the originator_mvv of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        ...
        :return: The originator_mvv of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: str
        """
    ...
    def originator_mvv(self, originator_mvv):
        """
        Sets the originator_mvv of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        Merchant Verification Value (MVV) is used to identify originators that participate in a variety of programs. The MVV is unique to the merchant.

        :param originator_mvv: The originator_mvv of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: str
        """
    ...
    def originator_name_abbreviation(self):
        """
        Gets the originator_name_abbreviation of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        A 4 character max name abbreviation for the originator.

        :return: The originator_name_abbreviation of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: str
        """
    ...
    def originator_name_abbreviation(self, originator_name_abbreviation):
        """
        Sets the originator_name_abbreviation of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        A 4 character max name abbreviation for the originator.

        :param originator_name_abbreviation: The originator_name_abbreviation of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: str
        """
    ...
    def card_terminal_id(self):
        """
        Gets the card_terminal_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        ...
        :return: The card_terminal_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :rtype: str
        """
    ...
    def card_terminal_id(self, card_terminal_id):
        """
        Sets the card_terminal_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        This field contains a code that identifies a terminal at the card acceptor location. This field is used in all messages related to a transaction. If sending transactions from a card not present environment, use the same value for all transactions.

        :param card_terminal_id: The card_terminal_id of this PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PaymentProductsPayoutsConfigurationInformationConfigurationsPullfunds):
            return False
