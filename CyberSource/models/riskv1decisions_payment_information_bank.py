...
class Riskv1decisionsPaymentInformationBank(object):
    """
    ...
    def __init__(self, account_number=None, code=None, country=None, iban=None):
        """
        Riskv1decisionsPaymentInformationBank - a model defined in Swagger
        """
    ...
    def account_number(self):
        """
        Gets the account_number of this Riskv1decisionsPaymentInformationBank.
        ...
        :return: The account_number of this Riskv1decisionsPaymentInformationBank.
        :rtype: str
        """
    ...
    def account_number(self, account_number):
        """
        Sets the account_number of this Riskv1decisionsPaymentInformationBank.
        Customer's bank account number. You can use this field only when scoring a direct debit transaction. Use this field if you do not or are not allowed to provide the IBAN. Note Do not use the IBAN in this field. Use nly the traditional account number information. For the IBAN, use bank_iban. 

        :param account_number: The account_number of this Riskv1decisionsPaymentInformationBank.
        :type: str
        """
    ...
    def code(self):
        """
        Gets the code of this Riskv1decisionsPaymentInformationBank.
        ...
        :return: The code of this Riskv1decisionsPaymentInformationBank.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        """
        Sets the code of this Riskv1decisionsPaymentInformationBank.
        Country-specific code used to identify the customer’s bank. Required for some countries if you do not or are not allowed to provide the IBAN instead. You can use this field only when scoring a direct debit transaction. For specific requirements, see \"Required Bank Account Information by Country,\" 

        :param code: The code of this Riskv1decisionsPaymentInformationBank.
        :type: str
        """
    ...
    def country(self):
        """
        Gets the country of this Riskv1decisionsPaymentInformationBank.
        ...
        :return: The country of this Riskv1decisionsPaymentInformationBank.
        :rtype: str
        """
    ...
    def country(self, country):
        """
        Sets the country of this Riskv1decisionsPaymentInformationBank.
        Country where the bank is located. Use the two-character ISO codes. You can use this field only when scoring a direct debit transaction. 

        :param country: The country of this Riskv1decisionsPaymentInformationBank.
        :type: str
        """
    ...
    def iban(self):
        """
        Gets the iban of this Riskv1decisionsPaymentInformationBank.
        ...
        :return: The iban of this Riskv1decisionsPaymentInformationBank.
        :rtype: str
        """
        return self._iban
    ...
    def iban(self, iban):
        """
        Sets the iban of this Riskv1decisionsPaymentInformationBank.
        International Bank Account Number (IBAN) for the bank account. For some countries you can provide this number instead of the traditional bank account information. You can use this field only when scoring a direct debit transaction. For specific requirements, see \"Required Bank Account Information by Country,\" 

        :param iban: The iban of this Riskv1decisionsPaymentInformationBank.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Riskv1decisionsPaymentInformationBank):
            return False
