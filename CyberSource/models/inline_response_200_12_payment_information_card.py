...
class InlineResponse20012PaymentInformationCard(object):
    """
    ...
    def __init__(self, suffix=None, prefix=None, expiration_month=None, expiration_year=None, start_month=None, start_year=None, issue_number=None, type=None, account_encoder_id=None, use_as=None):
        """
        InlineResponse20012PaymentInformationCard - a model defined in Swagger
        """
    ...
    def suffix(self):
        """
        Gets the suffix of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The suffix of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
        return self._suffix
    ...
    def suffix(self, suffix):
        """
        Sets the suffix of this InlineResponse20012PaymentInformationCard.
        Last four digits of the cardholder’s account number. This field is returned only for tokenized transactions. You can use this value on the receipt that you give to the cardholder. 

        :param suffix: The suffix of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def prefix(self):
        """
        Gets the prefix of this InlineResponse20012PaymentInformationCard.
        The description for this field is not available.

        :return: The prefix of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
        return self._prefix
    ...
    def prefix(self, prefix):
        """
        Sets the prefix of this InlineResponse20012PaymentInformationCard.
        The description for this field is not available.

        :param prefix: The prefix of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def expiration_month(self):
        """
        Gets the expiration_month of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The expiration_month of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
    ...
    def expiration_month(self, expiration_month):
        """
        Sets the expiration_month of this InlineResponse20012PaymentInformationCard.
        Two-digit month in which the credit card expires. `Format: MM`. Possible values: 01 through 12.  **Encoded Account Numbers**  For encoded account numbers (_type_=039), if there is no expiration date on the card, use 12.  For processor-specific information, see the customer_cc_expmo field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param expiration_month: The expiration_month of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def expiration_year(self):
        """
        Gets the expiration_year of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The expiration_year of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
    ...
    def expiration_year(self, expiration_year):
        """
        Sets the expiration_year of this InlineResponse20012PaymentInformationCard.
        Four-digit year in which the credit card expires. `Format: YYYY`.  **Encoded Account Numbers**  For encoded account numbers (_type_=039), if there is no expiration date on the card, use 2021.  For processor-specific information, see the customer_cc_expyr field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param expiration_year: The expiration_year of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def start_month(self):
        """
        Gets the start_month of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The start_month of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
    ...
    def start_month(self, start_month):
        """
        Sets the start_month of this InlineResponse20012PaymentInformationCard.
        Month of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. `Format: MM`. Possible values: 01 through 12.  The start date is not required for Maestro (UK Domestic) transactions. 

        :param start_month: The start_month of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def start_year(self):
        """
        Gets the start_year of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The start_year of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
    ...
    def start_year(self, start_year):
        """
        Sets the start_year of this InlineResponse20012PaymentInformationCard.
        Year of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. `Format: YYYY`.  The start date is not required for Maestro (UK Domestic) transactions. 

        :param start_year: The start_year of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def issue_number(self):
        """
        Gets the issue_number of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The issue_number of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
    ...
    def issue_number(self, issue_number):
        """
        Sets the issue_number of this InlineResponse20012PaymentInformationCard.
        Number of times a Maestro (UK Domestic) card has been issued to the account holder. The card might or might not have an issue number. The number can consist of one or two digits, and the first digit might be a zero. When you include this value in your request, include exactly what is printed on the card. A value of 2 is different than a value of 02. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card.  The issue number is not required for Maestro (UK Domestic) transactions. 

        :param issue_number: The issue_number of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this InlineResponse20012PaymentInformationCard.
        Type of card to authorize. - 001 Visa - 002 Mastercard - 003 Amex - 004 Discover 

        :return: The type of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this InlineResponse20012PaymentInformationCard.
        Type of card to authorize. - 001 Visa - 002 Mastercard - 003 Amex - 004 Discover 

        :param type: The type of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def account_encoder_id(self):
        """
        Gets the account_encoder_id of this InlineResponse20012PaymentInformationCard.
        Identifier for the issuing bank that provided the customer’s encoded account number. Contact your processor for the bank’s ID. 

        :return: The account_encoder_id of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
    ...
    def account_encoder_id(self, account_encoder_id):
        """
        Sets the account_encoder_id of this InlineResponse20012PaymentInformationCard.
        Identifier for the issuing bank that provided the customer’s encoded account number. Contact your processor for the bank’s ID. 

        :param account_encoder_id: The account_encoder_id of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def use_as(self):
        """
        Gets the use_as of this InlineResponse20012PaymentInformationCard.
        ...
        :return: The use_as of this InlineResponse20012PaymentInformationCard.
        :rtype: str
        """
        return self._use_as
    ...
    def use_as(self, use_as):
        """
        Sets the use_as of this InlineResponse20012PaymentInformationCard.
        Flag that specifies the type of account associated with the card. The cardholder provides this information during the payment process.  **Cielo** and **Comercio Latino**  Possible values:   - CREDIT: Credit card  - DEBIT: Debit card  This field is required for:  - Debit transactions on Cielo and Comercio Latino.  - Transactions with Brazilian-issued cards on CyberSource through VisaNet. 

        :param use_as: The use_as of this InlineResponse20012PaymentInformationCard.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse20012PaymentInformationCard):
            return False
