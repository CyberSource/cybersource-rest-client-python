...
class InlineResponse200Errors(object):
    """
    ...
    def __init__(self, type=None, message=None, details=None):
        """
        InlineResponse200Errors - a model defined in Swagger
        """
    ...
    def type(self):
        """
        Gets the type of this InlineResponse200Errors.
        ...
        :return: The type of this InlineResponse200Errors.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this InlineResponse200Errors.
        The type of error.  Possible Values:   - invalidHeaders   - missingHeaders   - invalidFields   - missingFields   - unsupportedPaymentMethodModification   - invalidCombination   - forbidden   - notFound   - instrumentIdentifierDeletionError   - tokenIdConflict   - conflict   - notAvailable   - serverError   - notAttempted  A \"notAttempted\" error type is returned when the request cannot be processed because it depends on the existence of another token that does not exist. For example, creating a shipping address token is not attempted if the required customer token is missing. 

        :param type: The type of this InlineResponse200Errors.
        :type: str
        """
    ...
    def message(self):
        ...
        :return: The message of this InlineResponse200Errors.
        :rtype: str
        """
    ...
    def message(self, message):
        """
        Sets the message of this InlineResponse200Errors.
        The detailed message related to the type.

        :param message: The message of this InlineResponse200Errors.
        :type: str
        """
    ...
    def details(self):
        """
        Gets the details of this InlineResponse200Errors.
    ...
    def details(self, details):
        """
        Sets the details of this InlineResponse200Errors.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse200Errors):
            return False
