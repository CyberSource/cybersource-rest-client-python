...
class Riskv1authenticationsPaymentInformationFluidData(object):
    """
    ...
    def __init__(self, value=None, key_serial_number=None, descriptor=None, encoding=None):
        """
        Riskv1authenticationsPaymentInformationFluidData - a model defined in Swagger
        """
    ...
    def value(self):
        """
        Gets the value of this Riskv1authenticationsPaymentInformationFluidData.
        ...
        :return: The value of this Riskv1authenticationsPaymentInformationFluidData.
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """
        Sets the value of this Riskv1authenticationsPaymentInformationFluidData.
        Represents the encrypted payment data BLOB. The entry for this field is dependent on the payment solution a merchant uses.  #### Used by **Authorization and Standalone Credits** Required for authorizations and standalone credits that use Bluefin PCI P2PE.  #### Card Present processing This field represents the encrypted Bluefin PCI P2PE payment data. Obtain the encrypted payment data from a Bluefin-supported device. 

        :param value: The value of this Riskv1authenticationsPaymentInformationFluidData.
        :type: str
        """
        if value is None:
    ...
    def key_serial_number(self):
        """
        Gets the key_serial_number of this Riskv1authenticationsPaymentInformationFluidData.
        ...
        :return: The key_serial_number of this Riskv1authenticationsPaymentInformationFluidData.
        :rtype: str
        """
    ...
    def key_serial_number(self, key_serial_number):
        """
        Sets the key_serial_number of this Riskv1authenticationsPaymentInformationFluidData.
        The encoded or encrypted value that a payment solution returns for an authorization request. For details about the valid values for a key, see [Creating an Online Authorization](https://developer.cybersource.com/api/developer-guides/dita-payments/CreatingOnlineAuth.html) 

        :param key_serial_number: The key_serial_number of this Riskv1authenticationsPaymentInformationFluidData.
        :type: str
        """
    ...
    def descriptor(self):
        """
        Gets the descriptor of this Riskv1authenticationsPaymentInformationFluidData.
        ...
        :return: The descriptor of this Riskv1authenticationsPaymentInformationFluidData.
        :rtype: str
        """
    ...
    def descriptor(self, descriptor):
        """
        Sets the descriptor of this Riskv1authenticationsPaymentInformationFluidData.
        The identifier for a payment solution, which is sending the encrypted payment data for decryption. Valid values: - Samsung Pay: `RklEPUNPTU1PTi5TQU1TVU5HLklOQVBQLlBBWU1FTlQ=`  **Note**: For other payment solutions, the value may be specific to the customer's mobile device. For example, the descriptor for a Bluefin payment encryption would be a device-generated descriptor.  #### Used by **Authorization and Standalone Credits** Required for authorizations and standalone credits that use Bluefin PCI P2PE.  #### Card Present processing Format of the encrypted payment data. The value for Bluefin PCI P2PE is `Ymx1ZWZpbg==`. 

        :param descriptor: The descriptor of this Riskv1authenticationsPaymentInformationFluidData.
        :type: str
        """
    ...
    def encoding(self):
        """
        Gets the encoding of this Riskv1authenticationsPaymentInformationFluidData.
        Encoding method used to encrypt the payment data.  Valid value: Base64 

        :return: The encoding of this Riskv1authenticationsPaymentInformationFluidData.
        :rtype: str
        """
    ...
    def encoding(self, encoding):
        """
        Sets the encoding of this Riskv1authenticationsPaymentInformationFluidData.
        Encoding method used to encrypt the payment data.  Valid value: Base64 

        :param encoding: The encoding of this Riskv1authenticationsPaymentInformationFluidData.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Riskv1authenticationsPaymentInformationFluidData):
            return False
