...
class InlineResponse2017EmbeddedProcessingInformation(object):
    """
    ...
    def __init__(self, payment_solution=None, business_application_id=None):
        """
        InlineResponse2017EmbeddedProcessingInformation - a model defined in Swagger
        """
    ...
    def payment_solution(self):
        """
        Gets the payment_solution of this InlineResponse2017EmbeddedProcessingInformation.
        ...
        :return: The payment_solution of this InlineResponse2017EmbeddedProcessingInformation.
        :rtype: str
        """
    ...
    def payment_solution(self, payment_solution):
        """
        Sets the payment_solution of this InlineResponse2017EmbeddedProcessingInformation.
        Type of digital payment solution that is being used for the transaction. Possible Values:   - **visacheckout**: Visa Checkout.  - **001**: Apple Pay.  - **005**: Masterpass. Required for Masterpass transactions on OmniPay Direct.  - **006**: Android Pay.  - **008**: Samsung Pay. 

        :param payment_solution: The payment_solution of this InlineResponse2017EmbeddedProcessingInformation.
        :type: str
        """
    ...
    def business_application_id(self):
        """
        Gets the business_application_id of this InlineResponse2017EmbeddedProcessingInformation.
        The description for this field is not available.

        :return: The business_application_id of this InlineResponse2017EmbeddedProcessingInformation.
        :rtype: str
        """
    ...
    def business_application_id(self, business_application_id):
        """
        Sets the business_application_id of this InlineResponse2017EmbeddedProcessingInformation.
        The description for this field is not available.

        :param business_application_id: The business_application_id of this InlineResponse2017EmbeddedProcessingInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2017EmbeddedProcessingInformation):
            return False
