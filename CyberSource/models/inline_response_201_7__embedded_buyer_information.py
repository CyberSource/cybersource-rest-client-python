...
class InlineResponse2017EmbeddedBuyerInformation(object):
    """
    ...
    def __init__(self, merchant_customer_id=None):
        """
        InlineResponse2017EmbeddedBuyerInformation - a model defined in Swagger
        """
    ...
    def merchant_customer_id(self):
        """
        Gets the merchant_customer_id of this InlineResponse2017EmbeddedBuyerInformation.
        ...
        :return: The merchant_customer_id of this InlineResponse2017EmbeddedBuyerInformation.
        :rtype: str
        """
    ...
    def merchant_customer_id(self, merchant_customer_id):
        """
        Sets the merchant_customer_id of this InlineResponse2017EmbeddedBuyerInformation.
        Your identifier for the customer.  For processor-specific information, see the customer_account_id field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param merchant_customer_id: The merchant_customer_id of this InlineResponse2017EmbeddedBuyerInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2017EmbeddedBuyerInformation):
            return False
