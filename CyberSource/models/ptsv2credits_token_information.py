...
class Ptsv2creditsTokenInformation(object):
    """
    ...
    def __init__(self, jti=None, transient_token_jwt=None, network_token_option=None, token_provisioning_information=None):
        """
        Ptsv2creditsTokenInformation - a model defined in Swagger
        """
    ...
    def jti(self):
        """
        Gets the jti of this Ptsv2creditsTokenInformation.
        TMS Transient Token, 64 hexadecimal id value representing captured payment credentials (including Sensitive Authentication Data, e.g. CVV). 

        :return: The jti of this Ptsv2creditsTokenInformation.
        :rtype: str
        """
        return self._jti
    ...
    def jti(self, jti):
        """
        Sets the jti of this Ptsv2creditsTokenInformation.
        TMS Transient Token, 64 hexadecimal id value representing captured payment credentials (including Sensitive Authentication Data, e.g. CVV). 

        :param jti: The jti of this Ptsv2creditsTokenInformation.
        :type: str
        """
    ...
    def transient_token_jwt(self):
        """
        Gets the transient_token_jwt of this Ptsv2creditsTokenInformation.
        Flex API Transient Token encoded as JWT (JSON Web Token), e.g. Flex microform or Unified Payment checkout result. 

        :return: The transient_token_jwt of this Ptsv2creditsTokenInformation.
        :rtype: str
        """
    ...
    def transient_token_jwt(self, transient_token_jwt):
        """
        Sets the transient_token_jwt of this Ptsv2creditsTokenInformation.
        Flex API Transient Token encoded as JWT (JSON Web Token), e.g. Flex microform or Unified Payment checkout result. 

        :param transient_token_jwt: The transient_token_jwt of this Ptsv2creditsTokenInformation.
        :type: str
        """
    ...
    def network_token_option(self):
        """
        Gets the network_token_option of this Ptsv2creditsTokenInformation.
        ...
        :return: The network_token_option of this Ptsv2creditsTokenInformation.
        :rtype: str
        """
    ...
    def network_token_option(self, network_token_option):
        """
        Sets the network_token_option of this Ptsv2creditsTokenInformation.
        Indicates whether a payment network token associated with a TMS token should be used for authorization. This field can contain one of following values:  - `ignore`: Use a tokenized card number for an authorization, even if the TMS token has an associated payment network token. - `prefer`: (Default) Use an associated payment network token for an authorization if the TMS token has one; otherwise, use the tokenized card number. 

        :param network_token_option: The network_token_option of this Ptsv2creditsTokenInformation.
        :type: str
        """
    ...
    def token_provisioning_information(self):
        """
        Gets the token_provisioning_information of this Ptsv2creditsTokenInformation.

        :return: The token_provisioning_information of this Ptsv2creditsTokenInformation.
    ...
    def token_provisioning_information(self, token_provisioning_information):
        """
        Sets the token_provisioning_information of this Ptsv2creditsTokenInformation.

        :param token_provisioning_information: The token_provisioning_information of this Ptsv2creditsTokenInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv2creditsTokenInformation):
            return False
