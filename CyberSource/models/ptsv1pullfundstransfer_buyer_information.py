...
class Ptsv1pullfundstransferBuyerInformation(object):
    """
    ...
    def __init__(self, vat_registration_number=None):
        """
        Ptsv1pullfundstransferBuyerInformation - a model defined in Swagger
        """
    ...
    def vat_registration_number(self):
        """
        Gets the vat_registration_number of this Ptsv1pullfundstransferBuyerInformation.
        ...
        :return: The vat_registration_number of this Ptsv1pullfundstransferBuyerInformation.
        :rtype: str
        """
    ...
    def vat_registration_number(self, vat_registration_number):
        """
        Sets the vat_registration_number of this Ptsv1pullfundstransferBuyerInformation.
        Customer's VAT registration number for the individual sender tax identification.  This field flows in ISO field 104, DSID 63 tag 06.  Visa is recommending the use of the following business application identifier (BAI) values  and merchant category code (MCC) combinations to process domestic bill payments, toll payments,  and business-to-business funding transactions as AFTs in Brazil: - BB (Business-to-business) - BP (Non-card bill payment) - FT (Funds transfer) - WT (Wallet transfer)  MCC: 4784  #### Mapping - SCMP API Field: purchaser_vat_registration_number - Simple Order API Field: invoiceHeader_purchaserVATRegistrationNumber - CCS: customer.vatRegistrationNumber  Optional field. 

        :param vat_registration_number: The vat_registration_number of this Ptsv1pullfundstransferBuyerInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Ptsv1pullfundstransferBuyerInformation):
            return False
