...
class BuyerInformation(object):
    ...
    def __init__(self, company_tax_id=None, currency=None, date_of_birth=None, personal_identification=None):
        """
        BuyerInformation - a model defined in Swagger
        """
    ...
    def company_tax_id(self):
        """
        Gets the company_tax_id of this BuyerInformation.
        ...
        :return: The company_tax_id of this BuyerInformation.
        :rtype: str
        """
    ...
    def company_tax_id(self, company_tax_id):
        """
        Sets the company_tax_id of this BuyerInformation.
        Tax identifier for the customer’s company.  **Important**: Contact your TeleCheck representative to find out whether this field is required or optional. 

        :param company_tax_id: The company_tax_id of this BuyerInformation.
        :type: str
        """
    ...
    def currency(self, currency):
        """
        Sets the currency of this BuyerInformation.
        Currency used by the customer. Accepts input in the ISO 4217 standard, stores as ISO 4217 Alpha.

        :param currency: The currency of this BuyerInformation.
        :type: str
        """
    ...
    def date_of_birth(self):
        """
        Gets the date_of_birth of this BuyerInformation.
        Date of birth of the customer.  Format: `YYYY-MM-DD` or `YYYYMMDD` 

        :return: The date_of_birth of this BuyerInformation.
        :rtype: str
        """
    ...
    def date_of_birth(self, date_of_birth):
        """
        Sets the date_of_birth of this BuyerInformation.
        Date of birth of the customer.  Format: `YYYY-MM-DD` or `YYYYMMDD` 

        :param date_of_birth: The date_of_birth of this BuyerInformation.
        :type: str
        """
    ...
    def personal_identification(self):
        """
        Gets the personal_identification of this BuyerInformation.

        :return: The personal_identification of this BuyerInformation.
    ...
    def personal_identification(self, personal_identification):
        """
        Sets the personal_identification of this BuyerInformation.

        :param personal_identification: The personal_identification of this BuyerInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, BuyerInformation):
            return False
