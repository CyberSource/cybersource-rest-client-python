...
class Tmsv3tokenstokenIdpaymentcredentialsOrderInformation(object):
    """
    ...
    def __init__(self, amount_details=None, bill_to=None):
        """
        Tmsv3tokenstokenIdpaymentcredentialsOrderInformation - a model defined in Swagger
        """
    ...
    def amount_details(self):
        """
        Gets the amount_details of this Tmsv3tokenstokenIdpaymentcredentialsOrderInformation.

        :return: The amount_details of this Tmsv3tokenstokenIdpaymentcredentialsOrderInformation.
        :rtype: Tmsv3tokenstokenIdpaymentcredentialsOrderInformationAmountDetails
        """
    ...
    def amount_details(self, amount_details):
        """
        Sets the amount_details of this Tmsv3tokenstokenIdpaymentcredentialsOrderInformation.

        :param amount_details: The amount_details of this Tmsv3tokenstokenIdpaymentcredentialsOrderInformation.
        :type: Tmsv3tokenstokenIdpaymentcredentialsOrderInformationAmountDetails
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv3tokenstokenIdpaymentcredentialsOrderInformation):
            return False
