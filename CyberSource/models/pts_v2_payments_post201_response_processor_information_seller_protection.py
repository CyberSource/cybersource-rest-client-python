...
class PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection(object):
    ...
    def __init__(self, type=None, eligibilty=None, eligibility_type=None):
        """
    ...
    def eligibilty(self):
        """
        Gets the eligibilty of this PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection.
        The level of seller protection in force for the transaction. Possible values: - `ELIGIBLE` - `PARTIALLY_ELIGIBLE` - `INELIGIBLE` 

        :return: The eligibilty of this PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection.
        :rtype: str
        """
    ...
    def eligibilty(self, eligibilty):
        """
        Sets the eligibilty of this PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection.
        The level of seller protection in force for the transaction. Possible values: - `ELIGIBLE` - `PARTIALLY_ELIGIBLE` - `INELIGIBLE` 

        :param eligibilty: The eligibilty of this PtsV2PaymentsPost201ResponseProcessorInformationSellerProtection.
        :type: str
        """
