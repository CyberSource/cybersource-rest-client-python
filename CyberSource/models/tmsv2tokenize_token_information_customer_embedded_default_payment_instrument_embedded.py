...
class Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentEmbedded(object):
    """
    ...
    def __init__(self, instrument_identifier=None):
        """
        Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentEmbedded - a model defined in Swagger
        """
    ...
    def instrument_identifier(self, instrument_identifier):
        """
        Sets the instrument_identifier of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentEmbedded.

        :param instrument_identifier: The instrument_identifier of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentEmbedded.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentEmbedded):
            return False
