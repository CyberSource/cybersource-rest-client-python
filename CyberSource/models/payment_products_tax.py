...
class PaymentProductsTax(object):
    """
    ...
    def __init__(self, subscription_information=None):
        """
        PaymentProductsTax - a model defined in Swagger
        """
    ...
    def subscription_information(self):
        """
        Gets the subscription_information of this PaymentProductsTax.

        :return: The subscription_information of this PaymentProductsTax.
    ...
    def subscription_information(self, subscription_information):
        """
        Sets the subscription_information of this PaymentProductsTax.

        :param subscription_information: The subscription_information of this PaymentProductsTax.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PaymentProductsTax):
            return False
