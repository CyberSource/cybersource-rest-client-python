...
class Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation(object):
    """
    ...
    def __init__(self, requestor_id=None, transaction_type=None):
        """
        Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation - a model defined in Swagger
        """
    ...
    def requestor_id(self, requestor_id):
        """
        Sets the requestor_id of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation.
        Value that identifies your business and indicates that the cardholder's account number is tokenized. This value is assigned by the token service provider and is unique within the token service provider's database.  **Note** This field is supported only through **VisaNet** and **FDC Nashville Global**. 
    ...
    def transaction_type(self):
        """
        Gets the transaction_type of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation.
        ...
        :return: The transaction_type of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation.
        :rtype: str
        """
    ...
    def transaction_type(self, transaction_type):
        """
        Sets the transaction_type of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation.
        Type of transaction that provided the token data. This value does not specify the token service provider; it specifies the entity that provided you with information about the token.  Set the value for this field to 1. An application on the customer's mobile device provided the token data. 

        :param transaction_type: The transaction_type of this Tmsv2tokenizeTokenInformationCustomerEmbeddedDefaultPaymentInstrumentCardTokenizedInformation.
        :type: str
        """
