...
class InlineResponse20013ResponseRecord(object):
    """
    ...
    swagger_types = {
        ...
        'card_type': 'str',
        'additional_updates': 'list[InlineResponse20013ResponseRecordAdditionalUpdates]'
    }
    ...
    def __init__(self, response=None, reason=None, token=None, instrument_identifier_id=None, instrument_identifier_created=None, card_number=None, card_expiry_month=None, card_expiry_year=None, card_type=None, additional_updates=None):
        """
        InlineResponse20013ResponseRecord - a model defined in Swagger
        """
    ...
    def response(self, response):
        """
        Sets the response of this InlineResponse20013ResponseRecord.
        Valid Values:   * NAN   * NED   * ACL   * CCH   * CUR   * NUP   * UNA   * ERR   * DEC 
    ...
    def reason(self, reason):
        """
        Sets the reason of this InlineResponse20013ResponseRecord.
    ...
    def token(self, token):
        """
        Sets the token of this InlineResponse20013ResponseRecord.
    ...
    def instrument_identifier_id(self, instrument_identifier_id):
        """
        Sets the instrument_identifier_id of this InlineResponse20013ResponseRecord.
    ...
    def instrument_identifier_created(self, instrument_identifier_created):
        """
        Sets the instrument_identifier_created of this InlineResponse20013ResponseRecord.
        Valid Values:   * true   * false 

        :param instrument_identifier_created: The instrument_identifier_created of this InlineResponse20013ResponseRecord.
        :type: str
        """
    ...
    def card_number(self, card_number):
        """
        Sets the card_number of this InlineResponse20013ResponseRecord.
    ...
    def card_expiry_month(self):
        """
        Gets the card_expiry_month of this InlineResponse20013ResponseRecord.

        :return: The card_expiry_month of this InlineResponse20013ResponseRecord.
        :rtype: str
        """
    ...
    def card_expiry_month(self, card_expiry_month):
        """
        Sets the card_expiry_month of this InlineResponse20013ResponseRecord.

        :param card_expiry_month: The card_expiry_month of this InlineResponse20013ResponseRecord.
        :type: str
        """
    ...
    def card_expiry_year(self, card_expiry_year):
        """
        Sets the card_expiry_year of this InlineResponse20013ResponseRecord.
    ...
    def card_type(self):
        """
        Gets the card_type of this InlineResponse20013ResponseRecord.

        :return: The card_type of this InlineResponse20013ResponseRecord.
        :rtype: str
        """
    ...
    def card_type(self, card_type):
        """
        Sets the card_type of this InlineResponse20013ResponseRecord.

        :param card_type: The card_type of this InlineResponse20013ResponseRecord.
        :type: str
        """
    ...
    def additional_updates(self):
        ...
        :rtype: list[InlineResponse20013ResponseRecordAdditionalUpdates]
        """
    ...
    def additional_updates(self, additional_updates):
        """
        Sets the additional_updates of this InlineResponse20013ResponseRecord.

        :param additional_updates: The additional_updates of this InlineResponse20013ResponseRecord.
        :type: list[InlineResponse20013ResponseRecordAdditionalUpdates]
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse20013ResponseRecord):
            return False
