...
class PaymentInstrumentApi(object):
    ...
    def delete_payment_instrument_with_http_info(self, profile_id, v_c_merchant_id, v_c_correlation_id, token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v1/paymentinstruments/{tokenId}', 'DELETE',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def get_payment_instrument_with_http_info(self, profile_id, v_c_merchant_id, v_c_correlation_id, token_id, **kwargs):
        ...
        return self.api_client.call_api('/tms/v1/paymentinstruments/{tokenId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
    ...
    def update_payment_instrument_with_http_info(self, profile_id, v_c_merchant_id, v_c_correlation_id, token_id, update_payment_instrument_request, **kwargs):
        ...
        return self.api_client.call_api('/tms/v1/paymentinstruments/{tokenId}', 'PATCH',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
