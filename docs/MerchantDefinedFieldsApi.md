...
> list[InlineResponse2004] create_merchant_defined_field_definition(reference_type, merchant_defined_field_definition_request)
...
> list[InlineResponse2004] get_merchant_defined_fields_definitions(reference_type)
