...
> ReportingV3RetrievalDetailsGet200Response get_retrieval_details(start_time, end_time, organization_id=organization_id)
...
api_instance = CyberSource.RetrievalDetailsApi()
...
try: 
    # Get Retrieval Details
    api_response = api_instance.get_retrieval_details(start_time, end_time, organization_id=organization_id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling RetrievalDetailsApi->get_retrieval_details: %s\n" % e)
```
