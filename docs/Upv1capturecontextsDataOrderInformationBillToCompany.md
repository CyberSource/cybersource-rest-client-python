...
**address3** | **str** | Additional address information (third line of the billing address) Optional field.  | [optional] 
**address4** | **str** | Additional address information (fourth line of the billing address) Optional field  | [optional] 
