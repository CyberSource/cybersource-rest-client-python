...
**original_purchase_date** | **str** | Date of original purchase. Required for recurring transactions. Format: &#x60;YYYYMMDDHHMMSS&#x60; **Note**: If this field is empty, the current date is used.  | [optional] 
