...
> PaymentInstrumentList get_instrument_identifier_payment_instruments_list(instrument_identifier_token_id, profile_id=profile_id, offset=offset, limit=limit)
