...
> list[InlineResponse2006] find_products_to_subscribe(organization_id)
...
> InlineResponse2016 notification_subscriptions_v2_webhooks_post(create_webhook=create_webhook)
...
# **save_sym_egress_key**
> InlineResponse2015 save_sym_egress_key(v_c_correlation_id=v_c_correlation_id, v_c_sender_organization_id=v_c_sender_organization_id, v_c_permissions=v_c_permissions, save_sym_egress_key=save_sym_egress_key)
...
v_c_sender_organization_id = 'v_c_sender_organization_id_example' # str | Sender organization id (optional)
v_c_permissions = 'v_c_permissions_example' # str | Encoded user permissions returned by the CGK, for the entity user who initiated the boarding (optional)
...
try: 
    # Create Webhook Security Keys
    api_response = api_instance.save_sym_egress_key(v_c_correlation_id=v_c_correlation_id, v_c_sender_organization_id=v_c_sender_organization_id, v_c_permissions=v_c_permissions, save_sym_egress_key=save_sym_egress_key)
    pprint(api_response)
except ApiException as e:
 ...
 **v_c_sender_organization_id** | **str**| Sender organization id | [optional] 
 **v_c_permissions** | **str**| Encoded user permissions returned by the CGK, for the entity user who initiated the boarding | [optional] 
