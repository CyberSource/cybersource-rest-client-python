...
------------ | ------------- | ------------- | -------------
**authentication_transaction_context_id** | **str** | Payer authentication transaction identifier passed to link the validation and authorization calls.  | [optional] 
...
**transaction_token** | **str** | Web based token used to authenticate consumer with Rupay authentication provider.  | [optional] 
